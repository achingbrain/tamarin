...
World.prototype.visit = function (page, params) {
    ...
    return driver.get(path)
        .then(this.getPageObject.bind(this))
};
...
World.prototype.getPageObject = function () {
    ...
    return world.driver.getCurrentUrl()
        .then(function (url) {
            ...
            var pageObject = buildPageObject.call(world, route && route.pageObject?route.pageObject:{});

            pageObject.route = route;
            world.pageObject = pageObject
        });
};

World.prototype.executeAsyncScript = function () {
    return driver.executeAsyncScript.apply(this, arguments);
};
