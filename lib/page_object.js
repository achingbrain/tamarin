...
module.exports = {
   ...
   expectPageToContain: function (id, next) {
      return this
         .get(id)
         .catch((e) => {
            throw new Error('Element not found: "' + id + '": ' +e.description);
         });
   },
   ...
   expectPageToEventuallyBe: function (page, next) {
      var expectedRoute = this.world.getRoute(page);
      return new until.Condition('expected page', function() {
         return true;
         //return this.pageObject.route === expectedRoute;
      });
   }
};
